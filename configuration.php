...
namespace Neodock
{
    /*
     * NOTICE!
     * It is highly recommended that you do not edit this file directly.  Instead, create a configuration_local.php file in the same location as this file.
     * This allows you to preserve your configuration settings during updates/upgrades.
     *
     *
     *
     *
...
//Database
    ...
    $config->set('db_dsn', 'sqlsrv:Server=sqlserver,1433;Database=NeodockRecipes');
...
//Error Handling
    //error page and controller to use
